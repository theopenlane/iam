...
func (_m *MockSdkClientWriteAuthorizationModelRequestInterface) Body(body client.ClientWriteAuthorizationModelRequest) client.SdkClientWriteAuthorizationModelRequestInterface {
	ret := _m.Called(body)
	...
	if rf, ok := ret.Get(0).(func(client.ClientWriteAuthorizationModelRequest) client.SdkClientWriteAuthorizationModelRequestInterface); ok {
		r0 = rf(body)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientWriteAuthorizationModelRequestInterface_Body_Call) Run(run func(body client.ClientWriteAuthorizationModelRequest)) *MockSdkClientWriteAuthorizationModelRequestInterface_Body_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(client.ClientWriteAuthorizationModelRequest))
	})
	return _c
}
...
func (_c *MockSdkClientWriteAuthorizationModelRequestInterface_Body_Call) RunAndReturn(run func(client.ClientWriteAuthorizationModelRequest) client.SdkClientWriteAuthorizationModelRequestInterface) *MockSdkClientWriteAuthorizationModelRequestInterface_Body_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSdkClientWriteAuthorizationModelRequestInterface) Execute() (*client.ClientWriteAuthorizationModelResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientWriteAuthorizationModelResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientWriteAuthorizationModelResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientWriteAuthorizationModelRequestInterface_Execute_Call) Return(_a0 *client.ClientWriteAuthorizationModelResponse, _a1 error) *MockSdkClientWriteAuthorizationModelRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientWriteAuthorizationModelRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientWriteAuthorizationModelResponse, error)) *MockSdkClientWriteAuthorizationModelRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSdkClientWriteAuthorizationModelRequestInterface) GetBody() *client.ClientWriteAuthorizationModelRequest {
	...
	var r0 *client.ClientWriteAuthorizationModelRequest
	if rf, ok := ret.Get(0).(func() *client.ClientWriteAuthorizationModelRequest); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.ClientWriteAuthorizationModelRequest)
		}
	}
...
func (_c *MockSdkClientWriteAuthorizationModelRequestInterface_GetBody_Call) Return(_a0 *client.ClientWriteAuthorizationModelRequest) *MockSdkClientWriteAuthorizationModelRequestInterface_GetBody_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSdkClientWriteAuthorizationModelRequestInterface_GetBody_Call) RunAndReturn(run func() *client.ClientWriteAuthorizationModelRequest) *MockSdkClientWriteAuthorizationModelRequestInterface_GetBody_Call {
	_c.Call.Return(run)
	return _c
}
