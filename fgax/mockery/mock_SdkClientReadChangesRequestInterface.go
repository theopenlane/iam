...
func (_m *MockSdkClientReadChangesRequestInterface) Execute() (*client.ClientReadChangesResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientReadChangesResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientReadChangesResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientReadChangesRequestInterface_Execute_Call) Return(_a0 *client.ClientReadChangesResponse, _a1 error) *MockSdkClientReadChangesRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientReadChangesRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientReadChangesResponse, error)) *MockSdkClientReadChangesRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
