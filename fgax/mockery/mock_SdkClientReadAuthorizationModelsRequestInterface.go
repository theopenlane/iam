...
func (_m *MockSdkClientReadAuthorizationModelsRequestInterface) Execute() (*client.ClientReadAuthorizationModelsResponse, error) {
	ret := _m.Called()
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientReadAuthorizationModelsResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientReadAuthorizationModelsResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientReadAuthorizationModelsRequestInterface_Execute_Call) Return(_a0 *client.ClientReadAuthorizationModelsResponse, _a1 error) *MockSdkClientReadAuthorizationModelsRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientReadAuthorizationModelsRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientReadAuthorizationModelsResponse, error)) *MockSdkClientReadAuthorizationModelsRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
