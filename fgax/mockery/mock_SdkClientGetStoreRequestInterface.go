...
func (_m *MockSdkClientGetStoreRequestInterface) Execute() (*client.ClientGetStoreResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientGetStoreResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientGetStoreResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientGetStoreRequestInterface_Execute_Call) Return(_a0 *client.ClientGetStoreResponse, _a1 error) *MockSdkClientGetStoreRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientGetStoreRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientGetStoreResponse, error)) *MockSdkClientGetStoreRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
