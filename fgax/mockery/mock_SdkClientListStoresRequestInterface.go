...
func (_m *MockSdkClientListStoresRequestInterface) Execute() (*client.ClientListStoresResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientListStoresResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientListStoresResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientListStoresRequestInterface_Execute_Call) Return(_a0 *client.ClientListStoresResponse, _a1 error) *MockSdkClientListStoresRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientListStoresRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientListStoresResponse, error)) *MockSdkClientListStoresRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
