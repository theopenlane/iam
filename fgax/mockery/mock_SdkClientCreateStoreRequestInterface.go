...
func (_m *MockSdkClientCreateStoreRequestInterface) Execute() (*client.ClientCreateStoreResponse, error) {
	ret := _m.Called()
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientCreateStoreResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientCreateStoreResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientCreateStoreRequestInterface_Execute_Call) Return(_a0 *client.ClientCreateStoreResponse, _a1 error) *MockSdkClientCreateStoreRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientCreateStoreRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientCreateStoreResponse, error)) *MockSdkClientCreateStoreRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
