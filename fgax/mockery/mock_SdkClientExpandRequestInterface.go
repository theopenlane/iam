...
func (_m *MockSdkClientExpandRequestInterface) Execute() (*client.ClientExpandResponse, error) {
	ret := _m.Called()
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientExpandResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientExpandResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientExpandRequestInterface_Execute_Call) Return(_a0 *client.ClientExpandResponse, _a1 error) *MockSdkClientExpandRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientExpandRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientExpandResponse, error)) *MockSdkClientExpandRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
