...
func (_m *MockSdkClientReadLatestAuthorizationModelRequestInterface) Execute() (*client.ClientReadAuthorizationModelResponse, error) {
	ret := _m.Called()
...
func (_c *MockSdkClientReadLatestAuthorizationModelRequestInterface_Execute_Call) Return(_a0 *client.ClientReadAuthorizationModelResponse, _a1 error) *MockSdkClientReadLatestAuthorizationModelRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientReadLatestAuthorizationModelRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientReadAuthorizationModelResponse, error)) *MockSdkClientReadLatestAuthorizationModelRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
