...
func (_m *MockSdkClientReadAssertionsRequestInterface) Execute() (*client.ClientReadAssertionsResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ClientReadAssertionsResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ClientReadAssertionsResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSdkClientReadAssertionsRequestInterface_Execute_Call) Return(_a0 *client.ClientReadAssertionsResponse, _a1 error) *MockSdkClientReadAssertionsRequestInterface_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSdkClientReadAssertionsRequestInterface_Execute_Call) RunAndReturn(run func() (*client.ClientReadAssertionsResponse, error)) *MockSdkClientReadAssertionsRequestInterface_Execute_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *MockSdkClientReadAssertionsRequestInterface_Expecter) GetStoreIdOverride() *MockSdkClientReadAssertionsRequestInterface_GetStoreIdOverride_Call {
	return &MockSdkClientReadAssertionsRequestInterface_GetStoreIdOverride_Call{Call: _e.mock.On("GetStoreIdOverride")}
}
