...
func (_m *MockSdkClient) BatchCheckExecute(request client.SdkClientBatchCheckRequestInterface) (*client.ClientBatchCheckResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(client.SdkClientBatchCheckRequestInterface) (*client.ClientBatchCheckResponse, error)); ok {
		return rf(request)
	}
	if rf, ok := ret.Get(0).(func(client.SdkClientBatchCheckRequestInterface) *client.ClientBatchCheckResponse); ok {
		r0 = rf(request)
	} else {
		if ret.Get(0) != nil {
